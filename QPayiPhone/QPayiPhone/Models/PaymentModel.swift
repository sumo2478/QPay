...
class PaymentModel {
    ...
    func recordPaymentInParse(itemId:String, username:String, name:String, note:String, completionHandler:PFBooleanResultBlock) -> Void {
        ...
        paymentRecord.setObject(name, forKey: "name");
        paymentRecord.setObject(note, forKey: "note");
